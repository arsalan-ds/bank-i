  ...
  const mintNftHandler = async () => {
    try {
      ...
      if (ethereum) {
        ...
        let nftTxn = await nftContract.methods.mintNFTs(1,'QmdXamq7uR51GaYLMNxMFqHmEEdDnkfPeU2bjKDVPgmnxm').send({ from: accounts[0], value: web3.utils.toWei("0.0001", "ether") }).on('receipt', function () {
          console.log('receipt')
        });
